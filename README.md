...
| `demo remove` | unregister + delete the demo dashboard fixture — removes the demo root and **exactly** the registry pointers whose base location sits under it (never a real project). A clean no-op when nothing is seeded |
