...
// A `switch (e.event)` narrows each of the 17 kinds to its member's fields with no `any` — this
...
test("a switch over the 17 narrowed kinds reads each member's fields", () => {
