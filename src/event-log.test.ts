...
// A `switch (e.event)` narrows each of the 26 kinds to its member's fields with no `any` — this
...
test("a switch over the 26 narrowed kinds reads each member's fields", () => {
